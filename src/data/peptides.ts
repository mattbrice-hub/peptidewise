...
export const peptides: Peptide[] = [
  ...
  },
  {
    ...
    slug: "semax",
    name: "Semax",
    aliases: ["ACTH(4-10) analog", "Met-Glu-His-Phe-Pro-Gly-Pro", "Heptapeptide Semax"],
    category: "cognitive",
    description:
    ...
    detailedDescription:
      "Semax is a synthetic analog of the adrenocorticotropic hormone (ACTH) fragment 4-10, with an added Pro-Gly-Pro tripeptide at the C-terminus for enhanced stability and bioavailability. Originally developed in Russia for treating stroke and cognitive disorders, Semax has demonstrated remarkable neuroprotective effects through multiple mechanisms including activation of neurotrophic factor expression (BDNF, NGF, NT-3), immunomodulation, and enhancement of cerebral circulation. Unlike traditional nootropics, Semax works at the genomic level, influencing the transcription of hundreds of genes related to nervous system function, immune response, and vascular health. It has been approved in Russia as a prescription medication for stroke recovery and cognitive enhancement.",
    benefits: [
      "Provides neuroprotection during ischemic events",
      "Enhances BDNF and neurotrophic factor expression",
      "Supports cognitive function, memory, and focus",
      "Modulates immune response in the central nervous system",
      "Promotes cerebral blood flow and vascular health",
    ...
    administrationRoutes: ["intranasal", "subcutaneous"],
    typicalDosage: "200-600 mcg intranasally, 1-3 times daily",
    cycleLength: "10-20 days per cycle, with breaks between cycles",
    sideEffects: [
    ...
    contraindications: [
      "Pregnancy or breastfeeding",
      "Active endocrine disorders without physician guidance",
      "Hypersensitivity to ACTH-related peptides",
    ],
    researchStatus: "emerging",
    legalStatus: "research-only",
    symptomTags: [
    ...
    relatedPeptideIds: ["selank", "epithalon", "mots-c"],
    fdaSearchTerms: ["Semax", "ACTH 4-10", "heptapeptide nootropic"],
    pubmedKeywords: [
      "Semax",
      "ACTH 4-10 analog",
    ...
    imageUrl: "/images/peptides/semax.svg",
    references: [
      {
        id: "semax-ref1",
        ...
        year: 2010,
        pmid: "19633950",
        finding: "Semax selectively activated transcription of BDNF, TrkC, and TrkA neurotrophins in ischemic rat brain cortex, demonstrating targeted neuroprotective gene activation.",
      },
      {
        id: "semax-ref2",
        ...
        year: 2014,
        pmid: "24661604",
        finding: "Genome-wide analysis revealed Semax predominantly enhanced immune-related gene expression and modified vascular development genes during brain ischemia, explaining its broad neuroprotective effects.",
      },
      {
        id: "semax-ref3",
        ...
        year: 1999,
        pmid: "10358912",
        finding: "Semax demonstrated angioprotective and antihypoxic properties during acute ischemic stroke, shifting immune balance toward anti-inflammatory cytokines while suppressing pro-inflammatory markers.",
      },
    ],
    researchScore: 7,
    safetyScore: 8,
    drTaylorNote: "Semax is one of the most well-researched nootropic peptides available. What sets it apart from other cognitive enhancers is that it works at the genetic level — upregulating BDNF and other neurotrophic factors that actually support brain health long-term, not just mask symptoms. The neuroprotective data from stroke research is impressive, and I find it pairs beautifully with Selank for patients looking for both cognitive enhancement and anxiety reduction. The intranasal delivery makes it very convenient for daily use.",
    mechanismOfAction: "Semax activates melanocortin receptors and modulates the expression of neurotrophic factors including BDNF, NGF, and NT-3 through genomic-level transcriptional changes. It enhances cerebral circulation via immunomodulatory pathways, shifts cytokine balance toward anti-inflammatory states, and promotes neuronal survival through transthyretin-mediated neuroprotection.",
    whoMayBenefit: ["Adults experiencing cognitive decline or brain fog", "Individuals recovering from neurological events", "People seeking enhanced memory, focus, and mental clarity", "Those interested in long-term neuroprotection and brain health"],
    timeline: "Improved focus and mental clarity often noticed within days. Neurotrophic and neuroprotective benefits build over 2-4 weeks of consistent use. Optimal results with cycling protocols.",
    lastUpdated: "2026-04-01",
    faqs: [
      { question: "What is Semax and how does it work?", answer: "Semax is a synthetic peptide derived from ACTH(4-10) that enhances brain function by upregulating neurotrophic factors like BDNF, supporting neuronal health, and modulating immune responses in the central nervous system." },
      { question: "How is Semax different from other nootropics?", answer: "Unlike stimulant-based nootropics, Semax works at the genetic level to increase production of brain-protective proteins. It doesn't just boost alertness — it supports actual neuronal growth and survival." },
      { question: "How is Semax administered?", answer: "Most commonly used as an intranasal spray at 200-600 mcg per dose, 1-3 times daily. This provides rapid absorption and direct access to the central nervous system." },
      { question: "How long does it take to see results?", answer: "Many people notice improved focus and clarity within the first few days. The deeper neuroprotective benefits develop over 2-4 weeks of consistent use." },
      { question: "Is Semax safe?", answer: "Semax has an excellent safety profile with decades of clinical use in Russia. Side effects are minimal — mainly mild nasal irritation with intranasal use. It has no known addictive properties." },
      { question: "Can Semax be combined with Selank?", answer: "Yes, Semax and Selank are frequently used together. Semax provides cognitive enhancement while Selank addresses anxiety — together they offer comprehensive brain support without sedation." },
    ],
  },
  {
    id: "5-amino-1mq",
  ...
  },
  {
    ...
    relatedPeptideIds: ["epithalon", "semax", "aod-9604"],
