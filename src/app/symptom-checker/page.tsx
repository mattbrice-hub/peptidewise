        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center gap-3">
              ...
              {s < 3 && (
                <div className={cn("w-12 h-0.5", step > s ? "gradient-primary" : "bg-gray-200")} />
              )}
            </div>
          ))}
        </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button
                ...
                className="flex-1 flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl gradient-primary text-white font-semibold hover:opacity-90 transition-opacity shadow-md"
              >
