...
export const metadata = {
  ...
  description: "Educational articles about peptide therapy, safety guides, and research insights.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Educational articles to help you understand peptide therapy, make informed decisions, and stay safe.
        </p>
      </div>
